...
review:  ## Review a PR (REPO=owner/repo PR=N GITHUB_OWNER_TOKEN=... or FORGEJO_OWNER_TOKEN=...)
	@env REVIEW_OUTPUT="$(or $(TERMINAL_OUTPUT),$(REVIEW_OUTPUT))" uv run python -m pr_auto_reviewer review --repo $(REPO) --pr $(PR)

review-force:  ## Force to review a PR (REPO=owner/repo PR=N GITHUB_OWNER_TOKEN=... or FORGEJO_OWNER_TOKEN=...)
	@env REVIEW_OUTPUT="$(or $(TERMINAL_OUTPUT),$(REVIEW_OUTPUT))" uv run python -m pr_auto_reviewer review --repo $(REPO) --pr $(PR) --force
