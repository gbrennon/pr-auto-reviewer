"""ForgejoCommentReader — wraps GitPlatformHttpClient to implement CommentReaderPort."""
...
class ForgejoCommentReader(CommentReaderPort):
    ...
    def get_comments(self, pr_id: PullRequestId) -> list[PrComment]:
        ...
        logger.info("ForgejoCommentReader return: %d comments for %s", len(comments), pr_id)
        return comments
