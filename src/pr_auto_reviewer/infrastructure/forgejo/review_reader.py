"""ForgejoReviewReader — wraps GitPlatformHttpClient to implement ReviewReaderPort."""
...
class ForgejoReviewReader(ReviewReaderPort):
    ...
    def get_latest_review(self, pr_id: PullRequestId) -> str | None:
        ...
        if isinstance(reviews, list):
            ...
            if sorted_reviews:
                ...
                logger.info("ForgejoReviewReader return: body=%s chars", len(body))
                return body
            ...
            logger.info("ForgejoReviewReader return: body=%s chars", len(body) if body else 0)
            return body
