...
class ForgejoChangesetFetcher(ChangesetFetcherPort):
    ...
    def fetch(self, pr_id: PullRequestId, sha: CommitSha) -> PullRequestDiff:
        ...
        raw_diff = self._client.get_raw(diff_path, repo=pr_id.repository)
        ...
        for file_path in sorted(file_paths):
            ...
            try:
                content = self._client.get_raw(raw_path, repo=pr_id.repository)
