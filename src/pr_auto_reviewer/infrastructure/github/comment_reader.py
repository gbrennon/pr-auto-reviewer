"""GithubCommentReader — wraps GitPlatformHttpClient to implement CommentReaderPort."""
...
class GithubCommentReader(CommentReaderPort):
    ...
    def get_comments(self, pr_id: PullRequestId) -> list[PrComment]:
        ...
        logger.info("GithubCommentReader return: %d comments for %s", len(comments), pr_id)
        return comments
