"""Tests for GitReviewReaderAdapter using fixture data."""
...
class TestGitReviewReaderAdapter:
    """Tests for GitReviewReaderAdapter using captured fixture data."""

    def test_get_latest_review(self, patched_client):
        """Get latest review returns a body string or None."""
        adapter = GitReviewReaderAdapter(patched_client)
